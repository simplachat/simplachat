...
<template>
    ...
    <GuestLayout>
        ...
        <form class="space-y-4" @submit.prevent="submit">
            ...
            <div class="flex flex-col sm:flex-row gap-y-1 sm:gap-0 sm:items-center justify-between">
                <div class="block">
                    <SwitchGroup as="div" class="flex items-center">
                        <SwitchLabel as="span" class="mr-3">
                            <span class="font-medium text-gray-900">Se souvenir de moi</span>
                        </SwitchLabel>
                        <Switch name="remember" id="remember" v-model="form.remember"/>
                    </SwitchGroup>
                </div>
                <div class="leading-6">
                    <a href="#" class="font-bold text-gray-700 underline hover:text-gray-900">Mot de passe oublié ?</a>
                </div>
            </div>
            <div>
                <PrimaryButton type="button" action="submit" class="mx-auto px-8" href="">
                    Je me connecte
                </PrimaryButton>
            </div>
        </form>
        <template #footer>
            <p class="mt-10 text-center text-sm text-gray-700 font-medium">
                ...
                {{ ' ' }}
                <a :href="route('register')" class="font-bold leading-6 text-gray-700 underline hover:text-gray-900">
