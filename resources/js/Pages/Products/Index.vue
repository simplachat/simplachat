...
const getProduct = async () => {
    loading.value = true;
    await axios.get('/api/products', {params: {paginate: 25}})
        .then(response => {
...
<template>
    <Head title="Simpl'Achat | Nos produits" />
    <Navbar />
    ...
    <main class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:pb-24 lg:max-w-7xl lg:px-8">
        ...
        <div class="pt-6 lg:grid lg:grid-cols-3 lg:gap-x-8 xl:grid-cols-4">
            <aside>
                ...
                <div class="hidden lg:block">
                    <form class="space-y-6 divide-y divide-gray-200">
                        <div v-for="(section, sectionIdx) in filters" :key="section.name" :class="sectionIdx === 0 ? null : 'pt-6'">
                            <fieldset>
            ...
            <div class="mt-6 lg:col-span-2 lg:mt-0 xl:col-span-3">
                <div v-if="products.data !== 0">
                    <div class="grid grid-cols-1 gap-6" v-if="!loading">
